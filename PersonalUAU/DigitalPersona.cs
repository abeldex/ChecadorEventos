...
namespace PersonalUAU
{
    public class DigitalPersona
    {
        ...
        ///</remarks>
        ///
        public void StartIdentify(Reader objReader, List<Clases.Persona> listPersons, string evento, string descripcion, string fechas, string id)
        {
            Identificacion.VistaIdentificacion Identificar = new Identificacion.VistaIdentificacion(objReader, listPersons, evento, descripcion, fechas, id);
            Identificar.Show();
        }
